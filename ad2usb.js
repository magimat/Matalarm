...
(function() {
  ...
  Alarm = (function(superClass) {
    ...
    Alarm.prototype.handlePanelData = function(msg) {
      ...
      // s'il y a le mot fault dans le message....
      if(sections[3].toLowerCase().indexOf('fault') != -1) {
        this.emit('fault', sections[1].charAt(2))
      }
      // sinon on assume que tout est ok
      else  {
        this.emit('ready')
      }
    ...
    Alarm.prototype.armStay = function(code, callback) {
      ...
      if (code) {
        return this.send(code + "7", callback);
      }
    };
